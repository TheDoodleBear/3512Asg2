...
//var_dump($ttt->status);die;


// Decode JSON data into PHP array
$response_data = json_decode($json_data);
//var_dump($response_data->current_page);
$ii = 0;
?>
<!-- header -->
<nav>
    ...
    <?php foreach($response_data->result as $row) : 
        ...
        <div class="col-md-4 pt-4">
            <div class="card">
                ...
                <a class="float-right" href="http://localhost/PHP_1/single-gallery.php?page=?id=<?php echo $row->GalleryID ?>" style="font-style: italic; color: #cccccc;">More detail...</a>
                </div>
            </div>
        </div>
    <?php 
